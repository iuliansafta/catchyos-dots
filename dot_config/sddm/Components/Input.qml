...
Column {
    ...
    property real fieldHeight: root.font.pointSize * 4.5

    function selectedUsername() {
        return (username.text || selectUser.currentText || "").toString();
    }
    ...
    Label {
        ...
        height: config.InputHeaderText == "" ? 0 : root.font.pointSize * 3
        width: parent.width / 2
        anchors.horizontalCenter: parent.horizontalCenter
        horizontalAlignment: Text.AlignHCenter
        verticalAlignment: Text.AlignVCenter
        text: config.InputHeaderText
        color: config.HeaderTextColor
        font.bold: true
        font.pointSize: root.font.pointSize * 2
        renderType: Text.QtRendering
        visible: config.InputHeaderText != ""
    }

    Item {
        id: usernameField

        height: config.HideUsernameField == "true" ? 0 : inputContainer.fieldHeight
        width: parent.width / 2
        anchors.horizontalCenter: parent.horizontalCenter
        visible: config.HideUsernameField == "true" ? false : true
        ...
        TextField {
            ...
            onAccepted: inputContainer.submitLogin()
    ...
    Item {
        ...
        Button {
            ...
            height: parent.height
            width: inputContainer.fieldHeight
            anchors.left: parent.left
    ...
    Item {
        ...
        Button {
            ...
            enabled: config.AllowEmptyPassword == "true" || inputContainer.selectedUsername() != "" && password.text != "" ? true : false
            hoverEnabled: true
            onClicked: inputContainer.submitLogin()
